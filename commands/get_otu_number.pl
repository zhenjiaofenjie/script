...
system("for i in unique*%/denovo/closed/*.biom;do echo \$i;biom summarize-table -i \$i | head -n 3;done > denovo_otu.txt");
...
my @file=("usearch_otu.txt","denovo_otu.txt","denovo_nochimeric_otu.txt","denovo_uchime_nochimeric_otu.txt");
